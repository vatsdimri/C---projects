...
static void treeFactory(GenericTree<int>& tree) {
  ...
  if(!rootptr){
    TreeNode* rootptr = new TreeNode(4);
  }
  rootptr->data = 4;
  rootptr->childrenPtrs.clear();
  
  rootptr->addChild(8);
  rootptr->addChild(15);
  rootptr->childrenPtrs[0]->addChild(16);
  rootptr->childrenPtrs[0]->addChild(23);
  rootptr->childrenPtrs[0]->childrenPtrs[0]->addChild(42);
